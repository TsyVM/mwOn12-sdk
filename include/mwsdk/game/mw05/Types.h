...
#ifndef MWSDK_MW05_RT_GAME_MW05_TYPES_H
#define MWSDK_MW05_RT_GAME_MW05_TYPES_H
...
#include "mwsdk/game/mw05/Shared/AllShared.h"
...
namespace mwsdk::mw05::rt {
  namespace Attrib {
    struct StringKey {
      ...
      StringKey() : StringKey(0ULL, 0U, nullptr) {}
    };
  ...
  namespace Math {
    using Vector2 = mwsdk::mw05::rt::Vector2;
    using Vector3 = mwsdk::mw05::rt::Vector3;
    using Vector4 = mwsdk::mw05::rt::Vector4;
    using Matrix4 = mwsdk::mw05::rt::Matrix4;
  }  // namespace Math
...
#endif  // MWSDK_MW05_RT_GAME_MW05_TYPES_H
